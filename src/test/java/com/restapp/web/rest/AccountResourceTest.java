...
import com.restapp.security.AuthoritiesConstants;
...
//            "alicejr@example.com", u.getLangKey(), u.getRoles(), u.getAddress(), u.getCity(), u.getState(), u.getZipCode(), u.getCreditCard(), u.getCcMonth(), u.getCcYear());
//
//        // Good user
//        restMvc.perform(
//            post("/api/register")
